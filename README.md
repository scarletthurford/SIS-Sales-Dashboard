...
<img width="1224" height="602" alt="Screenshot 2026-08-14 at 16 47 03" src="https://github.com/user-attachments/assets/db15ce08-384d-484a-9561-9d31e54cfad8" />

*An interactive Excel dashboard summarising Scarlett's In Stitches sales performance by product, hardware type, country, and date.*
...
- [Preparing the Data](#preparing-the-data)
  ...
  - [Creating a UK Region Lookup](#creating-a-uk-region-lookup)
...
The dashboard created from my dataset aims to analyse my sales performance and determine weaker areas where there may be growth opportunities. By bringing the most important metrics on one page, such as product type and customer location, I can explore how different factors influence overall revenue and demand.
...
## Tools 
Excel was used for data cleaning, visualisation, and analysis.
...
The steps taken to create the sales dashboard included:
- Using Excel PivotTables and PivotCharts to summarise the cleaned dataset.
- Adding slicers for product name, hardware type, and country to make the dashboard interactive.
- Connecting the slicers to the relevant PivotCharts so all visuals update together.
- Adding a timeline to explore trends across different months and years.
- Arranging all visuals on a single page for a clear overview of sales performance.

## Business Findings 
### **1. What is the best-selling item, and how does product performance vary across listings?**
From the dashboard, the best‑selling item is the **Smiley & Sad Daisy Crochet Earrings**, which consistently outperforms all other listings. This trend holds across every country with more than one sale, including both the UK and the US; this shows that the appeal is broad rather than country-specific. Across all countries combined, this single product accounts for approximately 46% shop’s total revenue, making it the clear driver of overall sales performance.

A similar product to the best-selling item is the **Rainbow Flower Smileys**, which also features bright colours and smiley-face motifs. Given the visual similarities, you might expect both designs to perform similarly. However, the data shows a striking preference for the Smiley & Sad Daisy Pair, which has sold over eight times more than the Rainbow Flower Smileys. This difference could be a result of several factors: the contrast between the smiley and sad faces creates a more expressive design, and the simpler yellow-and-white colour palette may appeal to customers who want something more versatile. I believe that the combination of these elements makes the Smiley & Sad Daisy earrings feel more distinctive, contributing to their higher demand.
...
<table align="center">
  <tr>
    <td align="center">
      ...
      <strong>Smiley & Sad Daisy Crochet Earrings</strong>
    </td>
    <td align="center">
      <img src="Images/Rainbow_Flower_Smileys.jpg" height="250px"><br>
      <strong>Rainbow Flower Smileys</strong>
    </td>
  </tr>
</table>
<br/>

Beyond the top-performing item, there is a clear mid-tier of products that still contribute to overall revenue but do not exhibit the same level of demand as the best-seller. These include the **Crochet Strawberry Earrings**, **Crochet Rainbow Earrings**, and **Crochet Tiered Rainbow Flower Earrings**.
...
The top three regions that contribute the most to overall revenue are:
1. London
...
For most of my listings, customers have the option to choose whether they want hoops or hooks as the hardware type. The dashboard shows that hooks account for the vast majority of sales, with hoops making up around 8% of sales. This indicates a clear customer preference for hooks across almost all product types.
